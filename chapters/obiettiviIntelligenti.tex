...
\subsubsection{Geometrical Hypercritical Queue Length}
...
\eq[,]{e:verticalqueue}{\quen{a,t} = \hcum{a,t} - \ecum{a,t}}
...
\todo{quel}
\fig{htbp}{PIX/undoguy.png}{f:quel}{ quel calculation }{width=0.4\textwidth}
