...
\\ \\
 & \gren{p} \geq & \flowratio_p \cdot \cycle{j} \quad \forall p \in \phaset_j \\
\end{array}
}
...
%\eq[;]{e:lag1}{
%\dld{\cycle{j}} = \frac{\partial\avgdelay{j}}{\cycle{j}} - 
%\sum_{p \in \phaset_j} \lambda_p \cdot \flowratio_p - \mu = 0
%}
%
%\eq[;]{e:lag2}{
%\dld{\gren{p}} = \frac{\partial\avgdelay{j}}{\gren{p}} + 
%\lambda_p + \mu = 0 \qquad \forall p \in \phaset_j
%}
%
%
%\eq[;]{e:lag3}{
%\dld{\lambda_p} = \gren{p} - \flowratio_p \cdot \cycle{j} - \eta_p^2 = 0 \qquad \forall p \in \phaset_j}
%\\
%\eq[;]{e:lag4}{
%\dld{\mu} = \sum_{p \in \phaset_j} \gren{p} + \tlost{j} - \cycle{j} = 0}
%\\
%\eq[.]{e:lag5}{
%\dld{\eta_p} = \eta_p \cdot \lambda_p = 0 \qquad \qquad \forall p \in \phaset_j}
...
signal setting with route choice \todo{ref (Smith, 1984; Cipriani and Fusco,
2008)}.
