...
\fig{htbp}{PIX/undoguy.png}{f:optima}{the Optima framework for real time traffic management}{width=0.4\textwidth}
...
TRE lies at the core of the Optima traffic management software suite, developed in Rome by PTV SISTeMa\footnote{ITS spinoff of Sapienza University, and partner in the present work \todo{???}} and running in traffic control centres around the globe.\\
