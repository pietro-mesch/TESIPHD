...
\eq[;]{e:fcum}{\fcum{a,t} = N(0,t) = \int_{0}^{t} f(\tau) \mathrm{d}\tau}
\eq[.]{e:ecum}{\ecum{a,t} = N(\length,t) = \int_{0}^{t} e(\tau) \mathrm{d}\tau}
