...
The next sections illustrate two numerical approaches to the complex problem of two-way bandwidth maximisation, \todo{the first being an effective incarnation of the classic paradigm of progression optimisation solved as a linear program with the addition of variable speed limits}, while the second is a much simpler yet effective geometrical method developed in the context of this work.
